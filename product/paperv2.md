...
Note that contracts can be created to interact with the money market on behalf of end users. Then middle layer contracts will provide flexibility to their creators and providers on its policies and rules.
