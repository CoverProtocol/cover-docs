...
* Participates in rewards mining by staking the above LP tokens with Cover protocol
...
* Participates in rewards mining by staking the above LP token with Cover Protocol
